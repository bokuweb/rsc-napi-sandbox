...
switch (platform) {
    ...
    switch (arch) {
      case "arm64":
        localFileExisted = existsSync(
          join(__dirname, "napi.android-arm64.node")
        );
        try {
          if (localFileExisted) {
            nativeBinding = require("./napi.android-arm64.node");
          } else {
            nativeBinding = require("next-napi-rs-android-arm64");
          }
        } catch (e) {
          loadError = e;
        }
      ...
      case "arm":
        localFileExisted = existsSync(
          join(__dirname, "napi.android-arm-eabi.node")
        );
        try {
          if (localFileExisted) {
            nativeBinding = require("./napi.android-arm-eabi.node");
          } else {
            nativeBinding = require("next-napi-rs-android-arm-eabi");
          }
        } catch (e) {
          loadError = e;
        }
      ...
      case "x64":
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require("next-napi-rs-win32-x64-msvc");
          }
        } catch (e) {
          loadError = e;
        }
      ...
      case "ia32":
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require("next-napi-rs-win32-ia32-msvc");
          }
        } catch (e) {
          loadError = e;
        }
      ...
      case "arm64":
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require("next-napi-rs-win32-arm64-msvc");
          }
        } catch (e) {
          loadError = e;
        }
  ...
  case "darwin":
    localFileExisted = existsSync(
      join(__dirname, "napi.darwin-universal.node")
    );
    try {
      if (localFileExisted) {
        nativeBinding = require("./napi.darwin-universal.node");
      } else {
        nativeBinding = require("next-napi-rs-darwin-universal");
      }
      break;
    } catch {}
    switch (arch) {
      case "x64":
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require("next-napi-rs-darwin-x64");
          }
        } catch (e) {
          loadError = e;
        }
      ...
      case "arm64":
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require("next-napi-rs-darwin-arm64");
          }
        } catch (e) {
          loadError = e;
        }
  ...
  case "freebsd":
    ...
    try {
      if (localFileExisted) {
        ...
        nativeBinding = require("next-napi-rs-freebsd-x64");
      }
    } catch (e) {
      loadError = e;
    }
        ...
        if (isMusl()) {
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require("next-napi-rs-linux-x64-musl");
            }
          } catch (e) {
            loadError = e;
          }
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require("next-napi-rs-linux-x64-gnu");
            }
          } catch (e) {
            loadError = e;
          }
        ...
        if (isMusl()) {
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require("next-napi-rs-linux-arm64-musl");
            }
          } catch (e) {
            loadError = e;
          }
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require("next-napi-rs-linux-arm64-gnu");
            }
          } catch (e) {
            loadError = e;
          }
      ...
      case "arm":
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require("next-napi-rs-linux-arm-gnueabihf");
          }
        } catch (e) {
          loadError = e;
        }
